...
you are certain you need to change it.
	<table>
			<tr>
				...
				<td>
					<input minlength="2" required class="inputbox" value="database" type="text" name="servername" required>				
				</td>
			</tr>
			<tr>
				<td>
	...
	<h3>Step<span class="tapcircle">2</span></h3>
		Now it's time to create the database user for Raspberry Pints to use. The default is "root" and you can keep the default if you would like.
		...
		<table>
			<tr>
				...
				<td>
					</label> <input class="inputbox" value="root" name="dbuser">				
				</td>
			</tr>
			<tr>
				<td>
